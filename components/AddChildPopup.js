            ...
            <div style={popupStyle}>
                <div style={boxStyle}>
                    <div style={contentDiv}>
                        ...
                        <SelectField title="Child Current Grade in School" field="grade" value={this.state.grade} editing={true} valueChanged={this.updateState} options={[{value: 1, display: "1st"}, {value: 2, display: "2nd"}, {value: 3, display: "3rd"}, {value: 4, display: "4th"}, {value: 5, display: "5th"}, {value: 6, display: "6th"}, {value: 7, display: "7th"}, {value: 8, display: "8th"}]}/>
